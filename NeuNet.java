...
public class NeuNet{
  ...
  public void back2(double t, int index){
    ...
    //Update W
    w1 = Matrix.subtract(w1, Matrix.sMul(0.03, deltaW1));
    w2 = Matrix.subtract(w2, Matrix.sMul(0.03, deltaW2));

    w1b = Matrix.subtract(w1b, Matrix.sMul(0.03, delta2));
    w2b = Matrix.subtract(w2b, Matrix.sMul(0.03, delta3));
  }
